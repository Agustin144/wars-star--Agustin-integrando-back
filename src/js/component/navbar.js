      ...
      <div className="nav-item dropdown">
        ...
        <ul className="dropdown-menu menu">
          {store.favoritos.map(item => (
            <li className="dropdown-item me-4"> {item.vehicle_id}{item.people_id}{item.starship_id}{item.species_id}{item.planets_id}  <span onClick={() => actions.eliminarFavorito(item)}><span className="ms-2 btn btn-danger float-end"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
